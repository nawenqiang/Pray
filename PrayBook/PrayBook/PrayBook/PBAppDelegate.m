...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[NSBundle mainBundle]loadNibNamed:@"PBTabBarViewController" owner:self options:nil];

    UINavigationController *nav = [[UINavigationController alloc] initWithRootViewController:_pbTabBarVC];
    ...
    self.drawerController = [[MMDrawerController alloc] initWithCenterViewController:nav leftDrawerViewController:leftSideNavController rightDrawerViewController:nil];
